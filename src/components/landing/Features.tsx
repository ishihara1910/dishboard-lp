    ...
    <section id="features" className="py-28">
      <div ref={ref} className="fade-in-up max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-navy mb-4">現場と経営を、ひとつに繋ぐ</h2>
          <p className="text-muted-foreground">店舗運営に必要な機能をオールインワンで提供。</p>
        </div>

        <div className="grid md:grid-cols-3 gap-6">
          {/* Featured card: col-span-2 */}
          <div className="relative md:col-span-2 group p-8 rounded-2xl bg-gradient-hero text-white border border-white/10 shadow-card overflow-hidden">
