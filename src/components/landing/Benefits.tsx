...
export function Benefits() {
  ...
  return (
    <section id="benefits" className="py-28 bg-gradient-orange text-white relative overflow-hidden">
      <div className="absolute -top-20 -right-20 w-96 h-96 bg-white/10 rounded-full blur-3xl" />
      <div ref={ref} className="fade-in-up relative max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-white/70 font-semibold text-sm tracking-widest mb-3">BENEFITS</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {benefits.map((b) => (
            <div
              key={b.title}
              className="p-8 rounded-2xl bg-white/15 backdrop-blur border border-white/20 hover:bg-white/25 transition"
            >
              <span className="inline-flex w-12 h-12 rounded-xl bg-white/20 items-center justify-center mb-5">
